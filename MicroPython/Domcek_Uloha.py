...
def Chimney(a, b, c):
    ...
    rightUpChimneyY = ay
    return (
        (leftDownChimneyX, leftDownChimneyY), (leftUpChimneyX, leftUpChimneyY), (rightUpChimneyX, rightUpChimneyY),
        (rightDownChimneyX, rightDownChimneyY))


machine.freq(160_000_000)  # 160M / 240M
valueOfBaudrate = 40_000_000  # 26.6_M / 40M / 80M
...
print("CPU freq {:.2f} MHz\nSPI freq {:.2f} MHz\nFPS 1. part: {:.2f} fps \nFPS 2. part: {:.2f} fps \n".format(
    (machine.freq() / 1000000), (valueOfBaudrate / 1000000), (maxFPSColors), (maxFPSImage)))
